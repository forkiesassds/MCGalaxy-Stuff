...
namespace MCGalaxy
{
    ...
    public sealed class PluginFifteenaGen : Plugin
    {
        public override string name { get { return "Plugin15aGen"; } }
        ...
        {
            MapGen.Register("Classic15a", GenType.Advanced, FifteenaGenerator.Gen, "&cThis is not accurate by any means! &HSeed affects how terrain is generated. If seed is the same, the generated level will be the same.");
        }
    ...
    public partial class FifteenaGenerator
    {
        ...
        public static bool Gen(Player p, Level lvl, string seed)
        {
            ...
            new FifteenaGenerator().Generate(lvl, seed_);
            return true;
        }
        ...
        void CreateSurfaceLayer()
        {
            ...
            for (int z = 0; z < Length; z++)
            {
                for (int x = 0; x < Width; x++)
                {
                    ...
                    if (blockAbove == Block.Water && y <= waterLevel - 1 && n2.Compute(x, z) > 12)
                    {
